...
function main(path, query)
{
  ...
  writeln("stylesheet %s", JSON.stringify("/extension-resource/FiddleAndTweak/showreview.css"));
  writeln("script %s", JSON.stringify("/extension-resource/FiddleAndTweak/common.js"));
  writeln("script %s", JSON.stringify("/extension-resource/FiddleAndTweak/showreview.js"));
}
